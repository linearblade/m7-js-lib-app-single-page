...
/*
  ...
  (typeof window === "object" && currentRoot === window.__treeRoot)
  );
  }
  ...
  // allow "window" / "globalThis" / "lib" / "window.somePath"
  ...
  // Dot path: walk from globalThis first
...
/*
  ...
  globalThis.testClass = class test { x = 1;static y = 2; static static_method(){}; instance_method(){}}
